...
var core = exports.core = {
    ...
    shop: function (showDisplay) {
        var shop = [
            ...
            ['voice', 'Get a Voice rank for yourself ! After buying it just pm an admin or any high staff (like @,&)', 50],
            ['roomintro', 'buys a welcome message for your room, Please contact any high staff after buying it', 40],
            ['moderator', 'You can be a mod if you buy this !', 188388348549],
            ['Anime theme', 'Wanna Become an Anime geek ? Buys a room specially for anime fan. The Buyer would be the owner, contact an admin!', 200],
        ];
    ...
    tournaments: {
        ...
        earningMoney: function () {
            if (this.amountEarn === 10) return '<u>Standard (8 players = 4 buck)</u> Double (4 players = 2 buck) Quadruple (2 players = 2 bucks)';
            if (this.amountEarn === 4) return 'Standard (8 players = 3 buck) <u>Double (4 players = 2 buck)</u> Quadruple (2 players = 2 bucks)';
            if (this.amountEarn === 2) return 'Standard (8 players = 2 buck) Double (4 players = 2 buck) <u>Quadruple (2 players = 2 bucks)</u>';
        }
    },
...
exports.sysopAccess = function () {
    ...
    var systemOperators = ['anrindas','ansirent','indiancharizard','anrin n','strom thunder',];
